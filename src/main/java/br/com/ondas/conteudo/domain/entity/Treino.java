package br.com.ondas.conteudo.domain.entity;

import br.com.ondas.conteudo.domain.enums.VideoStatus;
...
public class Treino {
    ...
    public VideoStatus getStatusVideo() { return statusVideo; }
    public String getUrlS3Cru() { return urlS3Cru; }
    public String getUrlStreamingHls() { return urlStreamingHls; }
    public String getUrlDownloadMp4() { return urlDownloadMp4; }
}
