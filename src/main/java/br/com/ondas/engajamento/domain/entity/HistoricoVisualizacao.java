...
public class HistoricoVisualizacao {
    ...
    public void atualizarProgresso(Integer segundoAtual, Integer duracaoTotalTreino) {
        ...
        if (duracaoTotalTreino == null || duracaoTotalTreino == 0) {
            return; // Evita ArithmeticException
        }
    ...
    public UUID getTreinoId() { return treinoId; }
    public Integer getSegundoParado() { return segundoParado; }
